    ...
    return (
      <div>
        {chats.map((chat, idx) => (
            ...
            params={{ id: chat.id }}>
                <li key={idx}>
                    <div className="flex items-center p-2 text-white hover:bg-rba-yellow hover:text-captn-dark-blue group rounded-lg ">
    ...
    return (
        <div className="w-full">
          {conversations.map((conversation, idx) => {
            const conversationBgColor = conversation.role === "user" ? "rba-yellow" : "captn-dark-blue";
            const conversationTextColor = conversation.role === "user" ? "captn-dark-blue" : "rba-dark-gray";
...
export default function ChatPage(props) {
    ...
    return (
        <div className='relative z-0 flex h-full w-full overflow-hidden h-screen'>
            ...
            <div style={{"borderRight": "1px solid #eae4d9"}} className="border-x-rba-dark-gray h-full px-3 py-4 overflow-y-auto bg-captn-dark-blue dark:bg-captn-dark-blue">
                        ...
                        {props.match.params.id ? (<div className="w-full pt-0 md:pt-2 md:pt-0 border-t md:border-t-0 dark:border-white/20 md:border-transparent md:dark:border-transparent md:pl-2 gizmo:pl-0 gizmo:md:pl-0 md:w-[calc(100%-.5rem)] absolute bottom-100 left-0 md:bg-vert-light-gradient bg-white dark:bg-gray-800 md:!bg-transparent dark:md:bg-vert-dark-gradient">
                            <form onSubmit={handleFormSubmit} className="">    
                                ...
                                <div className="relative">
                                    ...
                                    <input type="search" id="userQuery" name="search" className="block w-full p-4 pl-5 text-sm text-rba-dark-gray border border-gray-300 rounded-lg bg-captn-dark-blue focus:ring-blue-500 focus:border-blue-500 dark:bg-captn-dark-blue dark:border-gray-600 dark:placeholder-gray-400 dark:text-rba-dark-gray dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Send a message" required />
