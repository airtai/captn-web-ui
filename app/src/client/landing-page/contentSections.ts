...
export const features = [
  {
    ...
    description:
      'Capt’n understands your business and manages your digital marketing needs autonomously.',
    icon: '🤖', //'🤝',
    href: '',
  },
  {
  ...
  },
  {
    ...
    description:
      "Connect with ease to your Google Ads account and watch Capt'nAI work its magic.",
    icon: '🤝',
    href: '',
  },
  {
