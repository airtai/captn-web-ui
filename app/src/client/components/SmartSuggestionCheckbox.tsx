    ...
    <div className='pb-4 flex items-center group bg-captn-dark-blue'>
      ...
      >
        ...
        {chatType === 'daily_analysis' && (
          ...
          >
            <b>
              If you've made a selection through email, the option is
              pre-selected but can be changed. You can opt for all or just a few
              options as desired, and then click the send button. Alternatively,
              you can type your own responses in the input field below.
            </b>
          </p>
        )}
